...
#####Only the mean and Standard deviation measurements  - mean values grouped by Subject and Activity is summarized in this data set
...
2. Walking Upstairs (value 2)	: subject was walking up a staircase during the test
3. Walking Downstairs (value 3)	: subject was walking down a staircase during the test
